...
class ChatRequest(BaseModel):
    question: str = Field(..., min_length=1, examples=["What is a UiPath Coded Agent?"])
...
async def ask_agent(payload: ChatRequest) -> ChatResponse:
    """Send a question. Use the same session_id across calls to maintain conversation history."""
